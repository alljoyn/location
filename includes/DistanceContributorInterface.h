 ...
 ******************************************************************************/
#ifndef DISTANCE_CONTRIBUTOR_INTERFACE_H_
#define DISTANCE_CONTRIBUTOR_INTERFACE_H_

namespace org_alljoyn_locationservices { namespace distance { namespace Contributor {
const unsigned short int INTERFACE_VERSION = 1;

const char* const INTERFACE_NAME = 
    "org.alljoyn.locationservices.distance.Contributor";

const char* const INTERFACE_PATH = 
    "/Locationservices/Distance/Contributor";

const char* const INTERFACE_DESCRIPTION = 
    "Location Services Distance Contributor";

const char* const INTERFACE_XML =
    "<interface name=\"org.alljoyn.locationservices.distance.Contributor\">"
    "  <description language=\"en\">"
    "    Interface to add distance information to provider services" 
    "  </description>"
...
#endif /* DISTANCE_CONTRIBUTOR_INTERFACE_H_ */